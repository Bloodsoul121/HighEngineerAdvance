package com.blood.highengineeradvance.util;
...
public final class KeyboardUtils {
    ...
    public static void showSoftInput(final View view) {
        final InputMethodManager imm = (InputMethodManager) MainApplication.getApplication().getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    public static void hideSoftInput(final View view) {
        InputMethodManager imm =
                (InputMethodManager) MainApplication.getApplication().getSystemService(Context.INPUT_METHOD_SERVICE);
        //noinspection ConstantConditions
        imm.hideSoftInputFromWindow(view.getWindowToken(), 0);
    }
